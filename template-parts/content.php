...
<div class="row ">
	<div class="large-8 columns">
		...
		<div class="entry-author padd-15">
			<div class="row ">
			
				<div class="medium-2 columns">
					<div class="circle-image text-center padd-05 ">
						<?php echo get_avatar( get_the_author_meta( 'ID' ) ,100 ); ?>
					</div>
				</div>
				<div class="medium-10 columns">
					<h4 class="author-title bold-text">Written By <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php the_author(); ?></a></h4>
